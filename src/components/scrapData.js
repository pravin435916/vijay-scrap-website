export const scrapData = [
  // Paper Category
  { id: 1, name: 'Newspaper', category: 'Paper', rate: 10, unit: 'kg', image: '/scrap/newspaper.jpg' },
  { id: 2, name: 'Cardboard', category: 'Paper', rate: 11, unit: 'kg', image: '/scrap/khadde.jpg' },
  { id: 3, name: 'Books/Notebooks', category: 'Paper', rate: 11, unit: 'kg', image: '/scrap/books.jpg' },
  { id: 4, name: 'Record Paper', category: 'Paper', rate: 9, unit: 'kg', image: '/scrap/paper.jpg' },
  { id: 5, name: 'Magazines', category: 'Paper', rate: 10, unit: 'kg', image: '/scrap/magazine.jpg' },
  
  // Plastic Category
  { id: 6, name: 'PET Bottles', category: 'Plastic', rate: 15, unit: 'kg', image: '/scrap/pet_bottle.jpg' },
  { id: 7, name: 'Black Plastic', category: 'Plastic', rate: 5, unit: 'kg', image: '/scrap/black_plastic.jpg' },
  { id: 8, name: 'Plastic', category: 'Plastic', rate: 10, unit: 'kg', image: '/scrap/plastic.jpg' },
  ...
  // E-Waste Category
  { id: 19, name: 'Electronic Plate(kit)', category: 'E-Waste', rate: 40, unit: 'piece', image: '/scrap/electronic_plate(kit).jpg' },
  { id: 20, name: 'Xerox Machine', category: 'E-Waste', rate: 20, unit: 'piece', image: '/scrap/xerox_machine.jpg' },
